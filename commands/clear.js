module.exports = {
    ...
    async execute(message, config, sQueue) {
        ...
        if (!sQueue || !sQueue.songs || sQueue.songs.length == 0) return message.reply(":x: | There is no song that I could skip!");
        sQueue.songs.length = 1
    message.reply(":white_check_mark: **Cleard**!")
    },
};